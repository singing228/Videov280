import svgPaths from "./svg-6ge7hxx9ve";
...
function Hidden() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="_hidden">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="_hidden">
          <path d={svgPaths.p12c0c180} fill="var(--fill-0, #333333)" fillOpacity="0.6" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function TableHead() {
  return (
    <div className="bg-[rgba(0,0,0,0)] flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="<TableHead>">
      <div className="flex flex-row items-center size-full">
...
function TableHeadRow() {
  return (
    <div className="content-stretch flex h-[56px] items-center relative shrink-0 w-full" data-name="<TableHeadRow>">
...
function TableHeadRow1() {
  return (
    <div className="content-stretch flex flex-col h-[56px] items-start relative shrink-0 w-[552px]" data-name="Table Head Row">
      <TableHeadRow />
    </div>
  );
}
...
function TableHead1() {
  return (
    <div className="bg-[rgba(0,0,0,0)] flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="<TableHead>">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center pl-[16px] pr-0 py-[16px] relative size-full">
          <Frame1 />
          <Frame2 />
        </div>
      </div>
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="<DialogContent>">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start px-[24px] py-[16px] relative size-full">
          <p className="css-4hzbpn font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#333] text-[16px] tracking-[0.15px] w-[552px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function DialogAi() {
  return (
    <div className="absolute content-stretch flex flex-col h-[570px] items-start left-[calc(50%+139px)] top-[calc(50%+36px)] translate-x-[-50%] translate-y-[-50%] w-[600px]" data-name="Dialog - 匯入 AI 摘要">
      <Paper />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.4.3 若已有手動編輯資料 -> 讓使用者自由選擇">
      <Border />
      <MainContainer />
