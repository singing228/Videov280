import svgPaths from "./svg-u8f5o39y1k";
...
function Frame() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-[250px]">
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.43] min-h-px min-w-px relative text-[14px] text-[rgba(51,51,51,0.6)] tracking-[0.17px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        標題
      </p>
    </div>
  );
...
function Row() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Row">
      <p className="css-4hzbpn font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.43] relative shrink-0 text-[14px] text-[rgba(51,51,51,0.6)] tracking-[0.17px] w-[88px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        開始時間
      </p>
      <Frame />
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-full" data-name="Content">
      <div className="content-stretch flex flex-col items-start p-[4px] relative size-full">
        <div className="flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-black tracking-[0.15px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="css-4hzbpn leading-[1.5]">您已有手動編輯的分段內容。為避免覆蓋編輯內容，匯入 AI 後將保留現有分段並自動依時間排序，建議您稍後檢查順序是否符合需求。</p>
        </div>
      </div>
    </div>
  );
...
function Paper() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[280px] items-start left-[calc(50%+138px)] overflow-clip rounded-[4px] shadow-[0px_9px_46px_8px_rgba(0,0,0,0.12),0px_24px_38px_3px_rgba(0,0,0,0.14),0px_11px_15px_-7px_rgba(0,0,0,0.2)] top-[calc(50%+36px)] translate-x-[-50%] translate-y-[-50%] w-[444px]" data-name="<Paper>">
      <DialogElements />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.4 若已有手動編輯資料 -> 不覆蓋現有資料，跳出警語告知使用者會往下新增">
      <Border />
      <MainContainer />
