import svgPaths from "./svg-q40zlqdura";
...
function IconButton17() {
  return (
    <div className="absolute content-stretch flex flex-col items-center justify-center left-[44px] overflow-clip p-[8px] rounded-[100px] top-0" data-name="<IconButton>">
      <Icon14 />
    </div>
  );
}
...
export default function Component3() {
  return (
    <div className="bg-white relative size-full" data-name="4.0 影片管理首頁">
      <Border />
      <MainContainer />
    </div>
  );
