import svgPaths from "./svg-1bu34gedxb";
...
function CheckCircleFilled() {
  return (
    <div className="absolute left-[-2px] size-[18px] top-0" data-name="CheckCircleFilled">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="CheckCircleFilled">
          <path d={svgPaths.pdbf8c80} fill="var(--fill-0, #008A00)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Base2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
      <MaskedIcon2 />
      <p className="capitalize css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[22px] relative shrink-0 text-[#008a00] text-[15px] tracking-[0.46px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        已發佈
      </p>
    </div>
  );
...
function LibraryInstanceSlot() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-full" data-name="_Library / Instance Slot">
      <div className="content-stretch flex flex-col items-start p-[4px] relative size-full">
        <div className="flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-black tracking-[0.15px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="css-4hzbpn leading-[1.5]">取消發佈後，學生將無法看到影片段落，確定要取消嗎？</p>
        </div>
      </div>
    </div>
  );
...
function Base7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
      <p className="capitalize css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] text-white tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        確定
      </p>
    </div>
  );
...
function Paper() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[280px] items-start left-[636px] overflow-clip rounded-[4px] shadow-[0px_9px_46px_8px_rgba(0,0,0,0.12),0px_24px_38px_3px_rgba(0,0,0,0.14),0px_11px_15px_-7px_rgba(0,0,0,0.2)] top-[256px] w-[444px]" data-name="<Paper>">
      <DialogElements />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.11 點選「取消發布」">
      <Border />
      <MainContainer />
      <div className="absolute bg-[rgba(0,0,0,0.3)] bottom-0 h-[648px] left-[300px] w-[1117px]" data-name="mask" />
      <Paper />
    </div>
  );
}