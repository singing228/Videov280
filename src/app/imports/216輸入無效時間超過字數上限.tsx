import svgPaths from "./svg-bb26mfnnex";
  ...
  return (
    <div className="content-stretch flex items-center min-h-[24px] overflow-clip px-0 py-[8px] relative shrink-0 w-full" data-name="Content">
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px relative text-[#333] text-[16px] tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        兒童幸福感的定義與衡量兒童幸福感的定義與衡量福感的定義與衡量
      </p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="<FormHelperText>">
      <div className="content-stretch flex flex-col items-start pb-0 pt-[3px] px-[14px] relative w-full">
        <div className="flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#c00] text-[12px] tracking-[0.4px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="css-4hzbpn leading-[1.66]">字數上限為 30 個字</p>
        </div>
      </div>
    </div>
  );
...
function Base5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
      <p className="capitalize css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[22px] relative shrink-0 text-[15px] text-[rgba(0,0,0,0.38)] tracking-[0.46px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        儲存並發佈
      </p>
    </div>
  );
...
function SaveButton2() {
  return (
    <div className="bg-[rgba(0,0,0,0.12)] content-stretch flex flex-col items-center justify-center overflow-clip px-[10px] py-[4px] relative rounded-[4px] shrink-0" data-name="Save Button">
      <Base6 />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.16 輸入無效時間 & 超過字數上限">
      <Border />
      <MainContainer />
    </div>
  );
