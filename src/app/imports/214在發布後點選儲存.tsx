import svgPaths from "./svg-og1taf05y6";
...
function CheckCircle() {
  return (
    <div className="absolute left-0 size-[24px] top-0" data-name="check_circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="check_circle">
          <path d={svgPaths.p14672280} fill="var(--fill-0, #008A00)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IconCheckCircle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="icon/check_circle">
      <CheckCircle />
    </div>
  );
}
...
function DialogText() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Dialog text">
      <IconCheckCircle />
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px relative text-[16px] text-black tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.14 在發布後點選儲存">
      <Border />
      <MainContainer />
