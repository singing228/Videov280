import svgPaths from "./svg-wiqjy3qe5f";
...
function DialogText() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Dialog text">
      <IconCheckCircle />
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[16px] text-black tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <span className="leading-[1.5]">影片</span>
        <span className="leading-[1.5]" style={{ fontVariationSettings: "'wdth' 100" }}>
          段落
        </span>
        <span className="leading-[1.5]">已成功</span>
        <span className="leading-[1.5]" style={{ fontVariationSettings: "'wdth' 100" }}>
          發布
        </span>
        <span className="leading-[1.5]">！學生現在可以在影片播放頁查看最新內容。</span>
      </p>
    </div>
  );
}
...
function Paper() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[280px] items-start left-[637px] overflow-clip rounded-[4px] shadow-[0px_9px_46px_8px_rgba(0,0,0,0.12),0px_24px_38px_3px_rgba(0,0,0,0.14),0px_11px_15px_-7px_rgba(0,0,0,0.2)] top-[256px] w-[444px]" data-name="<Paper>">
      <DialogElements />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.9 發布成功">
      <Border />
      <MainContainer />
