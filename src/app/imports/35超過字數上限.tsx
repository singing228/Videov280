import svgPaths from "./svg-zxmek8kics";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Row">
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex items-center justify-end px-[16px] py-0 relative w-full">
          <Button4 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="<DialogTitle>">
      <div className="content-stretch flex flex-col items-start px-[24px] py-[16px] relative w-full">
        <p className="css-4hzbpn font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.235] relative shrink-0 text-[#333] text-[20px] tracking-[0.25px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          AI 分段品質回饋
        </p>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[30px]" data-name="Star #1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="StarSharp">
          <path d={svgPaths.p3c7d1e00} fill="var(--fill-0, #FFB400)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[30px]" data-name="Star #3">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 30 30">
        <g id="StarOutlineFilled">
          <path d={svgPaths.p32802880} fill="var(--fill-0, black)" fillOpacity="0.23" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex items-center min-h-[24px] overflow-clip px-0 py-[8px] relative shrink-0 w-full" data-name="Content">
      <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal leading-[1.43] min-h-px min-w-px relative text-[#333] text-[14px] tracking-[0.17px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字輸入超多字
      </p>
    </div>
  );
}
...
function Input16() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-full" data-name="Input">
      ...
      <div aria-hidden="true" className="absolute border border-[#c00] border-solid inset-0 pointer-events-none rounded-[4px]" />
    </div>
  );
}
...
function FormHelperText() {
  return (
    <div className="relative shrink-0 w-full" data-name="<FormHelperText>">
      <div className="content-stretch flex flex-col items-start pb-0 pt-[3px] px-[14px] relative w-full">
        <div className="flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#c00] text-[12px] tracking-[0.4px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="css-4hzbpn leading-[1.66]">超過字數上限 3000 字元</p>
        </div>
      </div>
    </div>
  );
...
function CoolTextField() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px overflow-clip relative w-full" data-name="<COOLTextField>">
      <Input16 />
      <FormHelperText />
    </div>
  );
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="<DialogContent>">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start justify-center px-[24px] py-[16px] relative size-full">
          <Cell8 />
          <Cell9 />
        </div>
      </div>
...
function Base7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
      <p className="capitalize css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#09c] text-[16px] tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        取消
      </p>
    </div>
  );
...
function Base8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
      <p className="capitalize css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] text-[rgba(0,0,0,0.38)] tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        確定
      </p>
    </div>
  );
...
function Action() {
  return (
    <div className="bg-[rgba(0,0,0,0.12)] content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] py-[6px] relative rounded-[4px] shrink-0" data-name="Action #1">
      <Base8 />
    </div>
  );
}
...
function DialogElements() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px min-w-px relative w-full" data-name="Dialog Elements">
      <DialogTitle />
      <DialogContent />
      <CoolDialogActions />
    </div>
...
function DialogAi() {
  return (
    <div className="absolute content-stretch flex flex-col h-[570px] items-start justify-center left-[calc(50%+137px)] top-[calc(50%+36px)] translate-x-[-50%] translate-y-[-50%] w-[600px]" data-name="Dialog - AI 摘要品質回饋">
      <Paper />
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3.5 超過字數上限">
      <Border />
      <MainContainer />
