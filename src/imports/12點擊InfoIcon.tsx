import svgPaths from "./svg-r6awzjgot4";
...
function CoolTooltip() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col items-start left-[1109px] overflow-clip px-[8px] py-[4px] rounded-[4px] shadow-[0px_1px_8px_0px_rgba(0,0,0,0.12),0px_3px_4px_0px_rgba(0,0,0,0.14),0px_3px_3px_-2px_rgba(0,0,0,0.2)] top-[268px] w-[298px]" data-name="<COOLTooltip>">
      <div className="flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#333] text-[0px] tracking-[0.17px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="css-4hzbpn leading-[1.43] mb-0 text-[14px]">AI 分段 (Beta) 說明</p>
        <ul className="list-disc">
          <li className="css-4hzbpn mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.43] text-[14px]">目前僅支援中、英文分段</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.43] text-[14px]">AI 分段是根據字幕生成，若無字幕或尚未生成，將無法匯入</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.43] text-[14px]">AI 生成內容僅供參考，可能含有語意誤差</span>
          </li>
          <li className="css-4hzbpn ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.43] text-[14px]">AI 分段由 NTU COOL 團隊於校內機房運算生成，未使用雲端 AI 服務</span>
          </li>
        </ul>
      </div>
    </div>
...
export default function Component12InfoIcon() {
  return (
    <div className="bg-white relative size-full" data-name="1.2 點擊 info icon">
      <Border />
      <MainContainer />
      <CoolTooltip />
    </div>
