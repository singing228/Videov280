import svgPaths from "./svg-js5xxtxnjq";
      ...
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start px-[8px] py-[4px] relative w-full">
          <div className="css-g0mm18 flex flex-col font-['Roboto:Regular','Noto_Sans_JP:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#333] text-[16px] text-center tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            <p className="css-ew64yg leading-[1.5]">AI 品質良好</p>
          </div>
        </div>
      </div>
    </div>
...
export default function Component30AihoverIconButtonTooltip() {
  return (
    <div className="bg-white relative size-full" data-name="3.0 匯入 AI 分段後，hover icon button 顯示 tooltip">
      <Border />
      <MainContainer />
