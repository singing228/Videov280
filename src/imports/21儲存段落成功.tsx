import svgPaths from "./svg-5886rwlzl6";
...
function Tooltip2() {
  return (
    <div className="absolute content-stretch flex items-center left-[398px] top-[467px]" data-name="<Tooltip>">
      <Tooltip1 />
    </div>
  );
}
...
function Alert() {
  return (
    <div className="absolute bg-[#edf7ed] content-stretch flex items-start left-[calc(50%+134px)] overflow-clip px-[16px] py-[6px] rounded-[4px] top-[96px] translate-x-[-50%]" data-name="<Alert>">
      <IconContainer />
      <Text />
      <OnCloseContainer />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="2.1  儲存段落成功">
      <Border />
      <MainContainer />
      <Tooltip2 />
