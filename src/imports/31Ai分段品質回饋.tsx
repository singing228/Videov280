import svgPaths from "./svg-bg3nrijctn";
    ...
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-[220px]" data-name="<Select>">
        <div className="relative rounded-[4px] shrink-0 w-full" data-name="Input">
          <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.23)] border-solid inset-0 pointer-events-none rounded-[4px]" />
          <div className="content-stretch flex flex-col items-start px-[12px] py-0 relative w-full">
            <div className="content-stretch flex items-center overflow-clip px-0 py-[8px] relative shrink-0 w-full" data-name="Container">
              <div className="h-[24px] shrink-0 w-0" data-name="min-height" />
              <div className="flex flex-[1_0_0] flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#333] text-[16px] tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                <p className="css-4hzbpn leading-[24px]">影片原文 (自動產生)</p>
              </div>
              <div className="h-0 shrink-0 w-[24px]" data-name="min-width" />
              <div className="absolute overflow-clip right-0 size-[24px] top-1/2 translate-y-[-50%]" data-name="ArrowDropDownFilled">
                <div className="absolute inset-[39.58%_29.17%]" data-name="Vector">
                  <div className="absolute inset-0" style={{ "--fill-0": "rgba(0, 0, 0, 1)" } as React.CSSProperties}>
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 5">
                      <path d="M0 0L5 5L10 0H0Z" fill="var(--fill-0, black)" fillOpacity="0.56" id="Vector" />
                    </svg>
                  </div>
                </div>
              </div>
    ...
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-[16px] items-start min-h-px min-w-px relative">
      <div className="bg-white relative rounded-[4px] shrink-0" data-name="Action #2">
        <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] py-[6px] relative rounded-[inherit]">
          <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
            <p className="capitalize css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] text-[rgba(51,51,51,0.6)] tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
              出現未提及內容
            </p>
          </div>
        </div>
        ...
        <div className="relative shrink-0 size-[30px]" data-name="Star #1">
          <div className="absolute inset-0 overflow-clip" data-name="StarSharp">
            <div className="absolute inset-[10.42%_8.33%]" data-name="Vector">
              <div className="absolute inset-0" style={{ "--fill-0": "rgba(255, 180, 0, 1)" } as React.CSSProperties}>
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative w-full" data-name="<COOLTextField>">
        <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[4px] w-full" data-name="Input">
          ...
          <div className="content-stretch flex flex-col items-start px-[12px] py-0 relative size-full">
            <div className="content-stretch flex items-center min-h-[24px] overflow-clip px-0 py-[8px] relative shrink-0 w-full" data-name="Content">
              <p className="css-4hzbpn flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[24px] min-h-px min-w-px relative text-[16px] text-[rgba(51,51,51,0.6)] tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                我們非常重視您的意見，可補充具體錯誤範例或改善建議
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative w-full" data-name="Dialog Elements">
      <div className="relative shrink-0 w-full" data-name="<DialogTitle>">
        <div className="content-stretch flex flex-col items-start px-[24px] py-[16px] relative w-full">
          <p className="css-4hzbpn font-['Roboto:Regular',sans-serif] font-normal leading-[1.235] relative shrink-0 text-[#333] text-[20px] tracking-[0.25px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            AI 分段品質回饋
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-row items-center justify-end size-full">
          <div className="content-stretch flex gap-[8px] items-center justify-end p-[8px] relative w-full">
            <div className="content-stretch flex flex-col items-center justify-center overflow-clip px-[8px] py-[6px] relative rounded-[4px] shrink-0" data-name="Action #2">
              <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
                <p className="capitalize css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[#09c] text-[16px] tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                  取消
                </p>
              </div>
            </div>
            <div className="bg-[#09c] content-stretch flex flex-col items-center justify-center overflow-clip px-[16px] py-[6px] relative rounded-[4px] shadow-[0px_1px_5px_0px_rgba(0,0,0,0.12),0px_2px_2px_0px_rgba(0,0,0,0.14),0px_3px_1px_-2px_rgba(0,0,0,0.2)] shrink-0" data-name="Action #1">
              <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Base">
                <p className="capitalize css-ew64yg font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] text-white tracking-[0.4px]" style={{ fontVariationSettings: "'wdth' 100" }}>
                  確定
                </p>
              </div>
            </div>
...
export default function Component31Ai() {
  return (
    <div className="bg-white relative size-full" data-name="3.1 AI 分段品質回饋">
      <Border />
      <MainContainer />
      <div className="absolute bg-[rgba(0,0,0,0.3)] bottom-0 h-[648px] left-[299px] w-[1117px]" data-name="mask" />
      <div className="absolute content-stretch flex flex-col h-[570px] items-start left-[calc(50%+137px)] top-[calc(50%+36px)] translate-x-[-50%] translate-y-[-50%] w-[600px]" data-name="Dialog - AI 摘要品質回饋">
        <Paper />
      </div>
