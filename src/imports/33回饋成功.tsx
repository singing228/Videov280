import svgPaths from "./svg-4fhtmewqky";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start overflow-clip px-0 py-[8px] relative shrink-0" data-name="Text">
      <p className="css-ew64yg font-['Roboto:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#1e4620] text-[16px] tracking-[0.15px]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <span className="leading-[1.5]" style={{ fontVariationSettings: "'wdth' 100" }}>
          AI 分段品質回饋
        </span>
        <span className="leading-[1.5]">成功。感謝您的寶貴建議。</span>
      </p>
    </div>
  );
}
...
function Alert() {
  return (
    <div className="absolute bg-[#edf7ed] content-stretch flex items-start left-[calc(50%+134.5px)] overflow-clip px-[16px] py-[6px] rounded-[4px] top-[calc(50%-238px)] translate-x-[-50%] translate-y-[-50%]" data-name="<Alert>">
      <IconContainer />
      <Text />
      <OnCloseContainer />
    </div>
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3.3 回饋成功">
      <Border />
      <MainContainer />
      <Alert />
